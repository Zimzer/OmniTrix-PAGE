...
const translations = {
  en: {
    ...
    cmd_repleaderboard_desc: "Displays the reputation ranking on this server",
    cmd_invite_desc: "Sends a link to invite the bot",
    cmd_prop_desc: "Submits a proposal to add a command or function",
    cmd_audit_desc: "Shows recent activity in server audit logs",
  ...
  pl: {
    ...
    cmd_repleaderboard_desc: "Wyświetla ranking reputacji na tym serwerze",
    cmd_invite_desc: "Wysyła link do zaproszenia bota",
    cmd_prop_desc: "Zgłasza propozycję dodania komendy lub funkcji",
  ...
  const utilityCommands = `
    <div class="command-group" data-group="Utility">
      ...
      <div class="command-category-list">
        ...
        <div class="command-item">
          <div class="command-name"><i class="fa-solid fa-slash" style="transform: scaleX(-0.5); margin-right: -5px;"></i>top</div>
          <div class="command-description" data-translate="cmd_top_desc">Display movie/series information</div>
          </div>
        </div>
    </div>
  `;
